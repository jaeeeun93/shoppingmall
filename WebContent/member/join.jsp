...
<link href="https://fonts.googleapis.com/css2?family=Source+Sans+Pro:wght@600&display=swap" rel="stylesheet">
	...
	<nav class="container"><!-- 전체감싸는 -->
		...
		<div class="logo2">
			...
			<div class="write">
				<p>
				<span style="font-size:60px;"><b>Welcome,</b></span><br>
				Adventure starts here.<br>Create an account to join with us.
				</p>
			</div>
			
			<form name="join" action="/member/member_insert.do" onsubmit="return validate();" method="post" >
				<div class="right">
					<div class="join">
						<span style="font-size:50;"><b>Create Account</b></span>
					</div>
					<div class="id">
						<div>
						...
						<div>
								<input type="text" id="id" name="id" maxlength="12" onkeydown="inputIdChk()"/>
						</div>
						...
						<div>
								<a onclick="id_check()" style="cursor:pointer"><input class="button" type="button" value="중복확인"></a>           
					           	<!-- 중복확인 버튼을 눌렸을 때 id_check 함수가 실행된다. -->
					          <!-- <input type="text" id="check" name="idDuplication" value="n" > 	중복체크여부
					           	<input type="text" id="check3" name="idDuplication2" value="n" >아이디사용여부 -->
					    </div>
					    <div style="width:20px">
						</div>
					    <div>       	
					 ...
					 <div class="pass">
						...
						<input type="password" id="pass" name="pass" maxlength="12" onchange="check_pw()"/>
						<div style="width:20px">
						</div>
						※ 4-12자의 영문 대소문자와 숫자로만 입력
					</div>
					<div class="check">
						...
						<input type="password" id="checkpass" name="checkpass" maxlength="12" onchange="check_pw()"/>&nbsp;<span id="check2"></span>
					</div>
					<div class="name">
					...
					<div class="email">
						...
						<input type="text" style="width:170px" id="email" name="email" placeholder="이메일" maxlength="20"/>
						<div style="width:20px">
						</div>
						 ※ ex) 111a@google.com
					</div>
					...
					<div class="address">
						...
						<div class="address2">
							<div style="width:127px;height:10px">
						</div>
							<input type="text" id="sample6_address" name="zip1" placeholder="주소">
						</div>
						<div style="height:10px">
							</div>
						<div class="address3">
							<div style="height:10px;width:127px">
							</div>
							<input type="text" id="sample6_detailAddress" name="zip2" placeholder="상세주소">
							<div style="width:20px">
							</div>
							<input type="text" id="sample6_extraAddress" name="zip3" placeholder="참고항목">
						</div>
					</div>
				<div class="submit">
						<div>
...
<script>
   function validate() {
       ...
       if(id.value=="") {//id="id"를 불러와서 value값이 ""일 때 alert 뜨고 
           alert("아이디를 입력해 주세요");
       ...
       <!-- 2020.11.27수정 -->
       if(!check(phonePattern, phone, "전화번호를 정확하게 입력해주세요")){
    	   join.phone.focus();
    	   return false;
       }
       <!-- 여기까지-->
